...
using Microsoft.ApplicationInsights.AspNetCore; // Ensure this is added
...
// Configure Application Insights using the new overload that accepts an action.
...
// (Optional) Add a Content Security Policy header for additional XSS protection.
